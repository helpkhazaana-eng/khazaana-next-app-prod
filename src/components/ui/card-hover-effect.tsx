...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white border border-slate-100 group-hover:border-slate-200 relative z-20 shadow-sm hover:shadow-md transition-all",
        className
      )}
    >
