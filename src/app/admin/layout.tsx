...
import { LayoutDashboard, Upload, FileText, LogOut, Store, ChefHat, BarChart, StickyNote } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-50 flex font-sans">
      ...
      <aside className="w-72 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white flex-shrink-0 hidden md:flex flex-col shadow-2xl">
        ...
        <div className="p-4 border-t border-slate-800/50">
          <Link 
            href="/" 
            className="flex items-center space-x-3 px-4 py-3 rounded-xl bg-slate-800/50 hover:bg-red-900/40 text-slate-400 hover:text-red-400 transition-all duration-200"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="md:hidden bg-gradient-to-r from-slate-900 to-slate-800 text-white p-4 flex justify-between items-center shadow-lg sticky top-0 z-30">
          ...
          <Link href="/" className="text-xs font-bold text-white bg-red-600/80 hover:bg-red-600 px-4 py-2 rounded-lg transition-colors">Exit</Link>
        </header>
