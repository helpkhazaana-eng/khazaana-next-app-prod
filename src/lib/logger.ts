...
import { Monitoring, ErrorSeverity, LogType } from './monitoring';
...
class Logger {
  ...
  info(message: string, data?: any, context?: string): void {
    ...
    Monitoring.log(LogType.INFO, message, { context, ...data });
  }
  ...
  warn(message: string, data?: any, context?: string): void {
    ...
    Monitoring.log(LogType.WARNING, message, { context, ...data });
  ...
  error(message: string, error?: Error, context?: string, data?: any): void {
    ...
    Monitoring.captureError(err, { context, ...data }, ErrorSeverity.MEDIUM);
  ...
  critical(message: string, error?: Error, context?: string, data?: any): void {
    ...
    // Forward to Monitoring Service
    const err = error || new Error(message);
    Monitoring.captureError(err, { context, ...data }, ErrorSeverity.CRITICAL);
